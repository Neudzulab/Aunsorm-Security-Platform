...
4. **Harici KMS Sağlayıcıları (Tamamlandı):** Yeni conformance fixture’ları ile
   HSM/PKCS#11 sertifikasyon raporları genişletildi ve `kms_certification_report`
   çıktısı doğrulama sürecine eklendi.
