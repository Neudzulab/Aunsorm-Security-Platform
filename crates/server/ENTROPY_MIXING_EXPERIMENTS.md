...
## V3: Interleaved Double-Mixing
**Placement**: Every 8-byte block gets both models (NEUDZ XOR AACM)
...
## V5: Alternating Byte-Level
**Placement**: Odd positions → NEUDZ, Even positions → AACM
