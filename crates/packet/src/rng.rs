//! Native Aunsorm RNG implementation for the packet crate.
//!
//! Provides the same entropy strategy as the server so nonce generation and
//! transcript material leverage the calibrated HKDF + NEUDZ-PCS mixing
//! pipeline without depending on OS-specific RNG calls across the codebase.
...
/// Create a new Aunsorm RNG instance for packet operations.
#[must_use]
