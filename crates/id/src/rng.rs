//! Native Aunsorm RNG implementation for the ID crate.
//!
//! Mirrors the entropy generation algorithm used by the Aunsorm server so
//! identifiers, tokens and other artefacts derive their randomness from the
//! same calibrated source across the workspace.
