...
## [Unreleased]
### Added
- File tabanlı GCP, Azure ve PKCS#11 KMS konnektörleri; strict kip ve fallback
  politikaları ile uyumlu JSON yapılandırması.
- Ortak ortam değişkenleri ile (`AUNSORM_KMS_*_STORE`) backend seçimi.
